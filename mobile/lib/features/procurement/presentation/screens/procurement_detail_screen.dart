        ...
        children: [
          ...
          _card(children: [
            ...
            Padding(padding: const EdgeInsets.fromLTRB(14, 0, 14, 14),
              child: Row(children: [
                const Text('Total', style: TextStyle(color: AppColors.textPrimary, fontSize: 13, fontWeight: FontWeight.w700)),
                const Spacer(),
                const Text('N\$79,500.00', style: TextStyle(color: AppColors.primary, fontSize: 15, fontWeight: FontWeight.w800)),
              ])),
          ]),
          const SizedBox(height: 12),
