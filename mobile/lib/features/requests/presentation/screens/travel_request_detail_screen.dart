        ...
        children: [
          ...
          _card(children: [
            ...
            Padding(padding: const EdgeInsets.fromLTRB(14, 0, 14, 12),
              child: Row(children: [
                const Text('Total Estimated Cost', style: TextStyle(color: AppColors.textPrimary, fontSize: 13, fontWeight: FontWeight.w700)),
                const Spacer(),
                const Text('N\$6,450.00', style: TextStyle(color: AppColors.primary, fontSize: 16, fontWeight: FontWeight.w800)),
              ])),
          ]),
          const SizedBox(height: 12),
          // Approval chain
