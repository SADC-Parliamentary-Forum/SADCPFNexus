...
export function canManageHandovers(user: AuthAccessUser | null | undefined): boolean {
  if (!user) return false;
  if (isSystemAdmin(user)) return true;
  return hasPermission(user, ["assets.handover.manage", "assets.admin", "assets.manage"]);
}
...
const ROUTE_ACCESS: RouteAccessRule[] = [
  ...
  { path: "/assignments/workload", permission: ["assignments.team", "assignments.admin"] },
  { path: "/assignments/handover", permission: ["assignments.team", "assignments.admin"] },
  ...
  { path: "/hr/imports", permission: ["hr.admin", "hr.edit", "leave.admin", "leave.balance.import"] },
  ...
  { path: "/assets/kits", permission: ["assets.handover.manage", "assets.admin", "assets.manage"] },
  { path: "/assets/operations", permission: ["assets.handover.manage", "assets.admin", "assets.manage", "assets.handover.accept", "assets.view"] },
  ...
  { path: "/assets/categories", permission: ["assets.create", "assets.edit", "assets.admin", "assets.manage", "assets.import"] },
  { path: "/assets/add", permission: ["assets.create", "assets.admin", "assets.manage", "assets.import"] },
  ...
  { path: "/procurement/from-document", permission: ["procurement.create", "procurement.admin", "procurement.manage_po"] },
  { path: "/procurement/exceptions", permission: ["procurement.view", "procurement.admin", "procurement.manage_po"] },
  { path: "/procurement/inbox", permission: ["procurement.create", "procurement.admin", "procurement.manage_po"] },
