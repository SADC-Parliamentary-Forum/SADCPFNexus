...
export const PROCUREMENT_SIDEBAR_CHILDREN = [
  { label: "Procurement", href: "/procurement", icon: "bar_chart_4_bars" },
...
export const PROCUREMENT_HUB_CARDS: HubCard[] = [
  ...
  { href: "/procurement/purchase-orders", title: "Purchase orders", purpose: "Issued POs.", icon: "receipt_long", section: "views" },
