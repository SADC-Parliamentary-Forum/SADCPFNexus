...
export default function Page() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ["people-authority", "my-delegations"],
    queryFn: async () => {
const me = (await peopleAuthorityApi.me()).data.data as any; return me.delegations ?? me;
    },
  });
  ...
  return (
    <div className="w-full min-w-0 space-y-5">
      ...
      <div className="card p-3">
        <label htmlFor="people-my-delegations-search-setq-e-target-value-placeholder-filter-ro" className="block text-xs font-medium text-neutral-600">
          Search
          <input id="people-my-delegations-search-setq-e-target-value-placeholder-filter-ro"
        ...
        <div className="card overflow-hidden">
          <div className="overflow-x-auto">
            <table className="data-table">
              <caption className="sr-only">My Delegations</caption>
              <thead>
                <tr>
                  {columns.map((c) => (
