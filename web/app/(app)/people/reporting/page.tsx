...
export default function Page() {
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      const chart = (await peopleAuthorityApi.orgChart()).data.data as any; return chart.reporting ?? chart;
    },
  });
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold text-neutral-900">Reporting Relationships</h1>
      </div>
