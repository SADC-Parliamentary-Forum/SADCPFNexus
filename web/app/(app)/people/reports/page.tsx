...
export default function Page() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ["people-authority", "people-reports"],
    queryFn: async () => {
return (await peopleAuthorityApi.reports("directory")).data;
    },
  });
  ...
  return (
    <div className="w-full min-w-0 space-y-5">
      ...
      <div className="card p-3">
        <label htmlFor="people-reports-search-setq-e-target-value-placeholder-filter-ro" className="block text-xs font-medium text-neutral-600">
          Search
          <input id="people-reports-search-setq-e-target-value-placeholder-filter-ro"
