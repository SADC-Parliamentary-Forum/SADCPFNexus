...
export default function Page() {
  const { data, isLoading, isError } = useQuery({
    queryKey: ["people-authority", "organisation-chart"],
    queryFn: async () => {
      return (await peopleAuthorityApi.orgChart()).data.data;
    },
  });
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold text-neutral-900">Organisation Chart</h1>
      </div>
