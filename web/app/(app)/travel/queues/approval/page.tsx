...
export default function TravelApprovalQueuePage() {
  ...
  useEffect(() => {
    travelApi.list({ queue: "approval", per_page: 50 })
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-4">
      <h1 className="text-2xl font-semibold text-neutral-900">Pending My Approval</h1>
      <p className="text-sm text-neutral-500">Travel requisitions awaiting recommendation or approval.</p>
          ...
          <tbody>
            {rows.length === 0 ? (
              ...
              <tr key={t.id}>
                ...
                <td>{t.purpose}</td>
                <td>{t.destination_city}, {t.destination_country}</td>
                <td>{t.status}</td>
              </tr>
            ))}
          </tbody>
