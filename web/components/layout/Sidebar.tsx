...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "QA Reviews (Phase 2)", href: "/audit/settings?stub=qa", icon: "verified" },
      { label: "AI Assist (Phase 3)", href: "/audit/settings?stub=ai", icon: "smart_toy" },
    ],
  },
  {
    ...
    children: [
      ...
      { label: "M365 Sync (Phase 2)", href: "/people/settings?stub=m365", icon: "cloud_sync" },
      { label: "AI Assist (Phase 3)", href: "/people/settings?stub=ai", icon: "smart_toy" },
    ],
  },
  {
