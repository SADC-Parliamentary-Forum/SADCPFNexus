...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "My Profile", href: "/people/my-profile", icon: "person" },
      { label: "My Delegations", href: "/people/my-delegations", icon: "swap_horiz" },
      { label: "My Signature", href: "/people/my-signature", icon: "draw" },
      { label: "Staff Directory", href: "/people/directory", icon: "contacts" },
      { label: "Organisation Chart", href: "/people/org-chart", icon: "account_tree" },
      { label: "Organisational Units", href: "/people/units", icon: "corporate_fare" },
      { label: "Positions", href: "/people/positions", icon: "work" },
      { label: "Position Assignments", href: "/people/assignments", icon: "assignment_ind" },
      { label: "Reporting Relationships", href: "/people/reporting", icon: "device_hub" },
      { label: "Job Descriptions", href: "/people/job-descriptions", icon: "description" },
      ...
      { label: "Signature Register", href: "/people/signatures", icon: "verified" },
      { label: "Onboarding", href: "/people/onboarding", icon: "person_add" },
      { label: "Offboarding", href: "/people/offboarding", icon: "person_remove" },
      { label: "Access Reviews", href: "/people/access-reviews", icon: "fact_check" },
      { label: "Recertification", href: "/people/recertification", icon: "event_repeat" },
      { label: "SoD Analysis", href: "/people/sod", icon: "rule" },
      { label: "Org Scenarios", href: "/people/scenarios", icon: "schema" },
      { label: "M365 Sync", href: "/people/m365", icon: "cloud_sync" },
      { label: "E-Sign", href: "/people/esign", icon: "draw" },
      { label: "Succession", href: "/people/succession", icon: "diversity_3" },
      { label: "Skills", href: "/people/skills", icon: "psychology" },
      { label: "Analytics", href: "/people/analytics", icon: "insights" },
      { label: "Privilege Alerts", href: "/people/privilege-alerts", icon: "warning" },
      { label: "Org Search", href: "/people/search", icon: "search" },
      { label: "AI Assist", href: "/people/ai", icon: "smart_toy" },
      { label: "Reports", href: "/people/reports", icon: "assessment" },
      { label: "Verify Signature", href: "/verify-signature", icon: "verified_user" },
      { label: "Settings", href: "/people/settings", icon: "settings" },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Forecasting (Phase 2)", href: "/stock/phase2/forecasting", icon: "trending_up" },
    ],
  },
  {
    label: "Governance",
