...
class HrPersonnelFileSectionPolicy
{
    ...
    public function view(User $user, HrPersonnelFileSection $model): bool
    {
    ...
    public function update(User $user, HrPersonnelFileSection $model): bool
    {
        return ($user->isSystemAdmin() || $user->hasPermissionTo('hr_settings.edit'))
            && $user->tenant_id === $model->tenant_id;
    }

    public function delete(User $user, HrPersonnelFileSection $model): bool
    {
        return ($user->isSystemAdmin() || $user->hasPermissionTo('hr_settings.edit'))
            && $user->tenant_id === $model->tenant_id;
    }
