...
class HrContractTypePolicy
{
    ...
    public function view(User $user, HrContractType $model): bool
    {
    ...
    public function update(User $user, HrContractType $model): bool
    {
        return ($user->isSystemAdmin() || $user->hasPermissionTo('hr_settings.edit'))
            && $user->tenant_id === $model->tenant_id;
    }

    public function delete(User $user, HrContractType $model): bool
    {
        return ($user->isSystemAdmin() || $user->hasPermissionTo('hr_settings.edit'))
            && $user->tenant_id === $model->tenant_id;
    }
