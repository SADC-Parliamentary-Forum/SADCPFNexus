...
class EventTypeRegistryService
{
    ...
    public static function catalogue(): array
    {
        return [
            ...
            ['event_key' => 'timesheet.import.uploaded', 'name' => 'Timesheet import uploaded', 'category' => 'Timesheet', 'severity' => 'informational'],
            ['event_key' => 'timesheet.import.confirmed', 'name' => 'Timesheet import confirmed', 'category' => 'Timesheet', 'severity' => 'medium'],
            ['event_key' => 'timesheet.import.verified', 'name' => 'Timesheet import verified', 'category' => 'Timesheet', 'severity' => 'medium'],
            ['event_key' => 'timesheet.import.rolled_back', 'name' => 'Timesheet import rolled back', 'category' => 'Timesheet', 'severity' => 'high'],
            ['event_key' => 'timesheet.import.reversed', 'name' => 'Timesheet import reversed', 'category' => 'Timesheet', 'severity' => 'high'],
