...
class NotificationTemplateController extends Controller
{
    private array $defaults = [
        ...
        // Assets custody
        ['name' => 'Asset acknowledgement required', 'trigger_key' => 'assets.acknowledgement_required', 'subject' => 'Accept custody of {{tag}}', 'body' => "Dear {{name}},\n\n{{asset}} ({{tag}}) has been assigned to you. Please open My Assets and Accept or Decline to verify custody.\n\nRegards,\nSADC-PF Administration"],
        ['name' => 'Asset assignment declined', 'trigger_key' => 'assets.assignment_declined', 'subject' => 'Assignment declined — {{tag}}', 'body' => "Dear {{name}},\n\n{{asset}} ({{tag}}) was declined by the recipient.\n\nReason: {{reason}}\n\nRegards,\nSADC-PF Administration"],
        ['name' => 'Asset return requested', 'trigger_key' => 'assets.return_requested', 'subject' => 'Asset return requested — {{tag}}', 'body' => "Dear {{name}},\n\nA return has been requested for {{asset}} ({{tag}}). Please confirm in Nexus.\n\nRegards,\nSADC-PF Administration"],
        ['name' => 'Asset returned', 'trigger_key' => 'assets.returned', 'subject' => 'Asset return confirmed — {{tag}}', 'body' => "Dear {{name}},\n\nReturn of {{asset}} ({{tag}}) has been confirmed. You are no longer the custodian.\n\nRegards,\nSADC-PF Administration"],
        ...
        ['name' => 'Timesheet Import Completed',     'trigger_key' => 'timesheet.import.completed', 'subject' => 'Timesheet import completed — {{reference}}', 'body' => "Dear {{name}},\n\nTimesheet import {{reference}} ({{filename}}) finished. {{imported}} records were imported.\n\nRegards,\nSADC-PF HR"],
        ['name' => 'Timesheet Import Errors',        'trigger_key' => 'timesheet.import.errors', 'subject' => 'Timesheet import needs attention — {{reference}}', 'body' => "Dear {{name}},\n\nTimesheet import {{reference}} ({{filename}}) completed with {{errors}} row errors. Review the batch before verification.\n\nRegards,\nSADC-PF HR"],
        ['name' => 'Timesheet Import Verification',  'trigger_key' => 'timesheet.import.verification_required', 'subject' => 'Historical timesheet verification required — {{reference}}', 'body' => "Dear {{name}},\n\nImport {{reference}} is ready for historical verification.\n\nRegards,\nSADC-PF HR"],
        ['name' => 'Timesheet Import Verified',      'trigger_key' => 'timesheet.import.verified', 'subject' => 'Historical timesheet batch verified — {{reference}}', 'body' => "Dear {{name}},\n\nImport {{reference}} has been verified as historical records.\n\nRegards,\nSADC-PF HR"],
