...
return new class extends Migration
{
    ...
    {
        // Tenant-scoped tables: grant + RLS + tenant_isolation policy
        $tenantTables = [
            'programmes',
            'workplan_events',
        ];
        ...
        // Child tables (no tenant_id, access via parent FK): grant only
        $childTables = [
            'programme_activities',
            'programme_milestones',
            'programme_deliverables',
            'programme_budget_lines',
            'programme_procurement_items',
        ];
    ...
    {
        $tenantTables = ['programmes', 'workplan_events'];
        foreach ($tenantTables as $table) {
