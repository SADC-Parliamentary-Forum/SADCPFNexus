...
{
    private function makeEvaluatingTender(Tenant $tenant, int $officerId, Vendor $vendor): array
    {
        $req = ProcurementRequest::create([
            'tenant_id'          => $tenant->id,
            'requester_id'       => $officerId,
    ...
    public function test_award_creates_contract_linked_to_tender_and_budget_line(): void
    {
        ...
        [$req, $tender, $quote] = $this->makeEvaluatingTender($tenant, $officer->id, $vendor);
