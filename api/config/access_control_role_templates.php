...
return [
    ...
    'HR and Administration Officer' => [
        ...
        'risk_level' => 'high',
        'permissions' => ['leave.module.view', 'leave.balance.certify.assigned', 'leave.balance.read.assigned_staff', 'leave.calendar.view.organisation', 'leave.report.view', 'leave.balance.export', 'travel.module.view', 'admin.organisation.manage'],
        'inherits' => [],
    ...
    'Finance Officer' => [
        ...
        'risk_level' => 'critical',
        'permissions' => ['programme.finance_review.read.assigned', 'programme.finance_review.update.assigned', 'programme.budget_availability.confirm.assigned', 'programme.module.view', 'salary_advance.module.view', 'salary_advance.financial_details.read.assigned', 'salary_advance.salary_verify.assigned', 'salary_advance.outstanding_advance_verify.assigned', 'salary_advance.threshold_verify.assigned', 'salary_advance.finance_certify.assigned', 'salary_advance.payroll_deduction.record.assigned', 'reports.view.authorised', 'reports.export.authorised'],
        'inherits' => [],
